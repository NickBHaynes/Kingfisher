...
public class TripleExplosion : UniversalExplosion {
	...
	// First Explosion :
		// Make sure to comment the existing FirstExplosion() method!
	private void FirstExplosion () {
		...
		Physics2D.OverlapCircleNonAlloc (_transform.position + firstExplosionOffset,firstExplosionRadius,collidersNonAloc,layerFilter,minDepth,maxDepth);
	...
	private void SecondExplosion () {
		...
		// Then we get all colliders that fall within circular area.
		Physics2D.OverlapCircleNonAlloc (_transform.position + secondExplosionOffset,secondExplosionRadius,collidersNonAloc,layerFilter,minDepth,maxDepth);
	...
	private void ThirdExplosion () {
		...
		// Then we get all colliders that fall within circular area.
		Physics2D.OverlapCircleNonAlloc (_transform.position + thirdExplosionOffset,thirdExplosionRadius,collidersNonAloc,layerFilter,minDepth,maxDepth);
