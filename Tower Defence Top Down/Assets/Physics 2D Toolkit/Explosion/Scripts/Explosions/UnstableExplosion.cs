...
public class UnstableExplosion : UniversalExplosion {
	...
	// Shake :
		// Make sure to comment the existing Shake() method!
	private void Shake () {
		...
		Physics2D.OverlapCircleNonAlloc (_transform.position + shakeOffset,shakeRadius,collidersNonAloc,layerFilter,minDepth,maxDepth);
