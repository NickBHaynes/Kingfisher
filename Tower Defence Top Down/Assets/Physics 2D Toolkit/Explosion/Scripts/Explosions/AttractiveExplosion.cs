...
public class AttractiveExplosion : UniversalExplosion {
	...
	// Attraction Force Handler :
		// Make sure to comment the existing AttractionForceHandler() method!
	private void AttractionForceHandler () {
		...
		Physics2D.OverlapCircleNonAlloc (_transform.position + attractionOffset,attractionRadius,collidersNonAloc,layerFilter,minDepth,maxDepth);
